...
import styles from "../style/tieudecongdong.style";
...
const UserHeader = () => {
  ...
  const handleSearch = () => {
   if (searchQuery.trim()) {
     router.push({
       pathname: "../screen/timkiembaiviet",
    ...
    >
      <View style={styles.topHeader}>
        ...
        <View style={styles.headerTextContainer}>
         ...
         <TouchableOpacity style={styles.iconButton} onPress={() => router.push("../screen/thongbaocongdong")}>
            <Ionicons name="notifications" size={22} color="black" />
         </TouchableOpacity>
         <TouchableOpacity
            style={styles.iconButton}
            onPress={() => router.push({pathname:"../screen/baivietdaluu", params:{id: nguoiDung?._id}})}
         >
